...
Map::path('company/view/{integer}', function($idx) {
    ...
    $data['stock_list']         = ($company->getIdx()!=null)?CompanyStockM::new()->setCompanyIdx($company->getIdx())->getList('date', 'desc', 100, 0):array();
...
Map::path('company/comparesvm/{integer}/{integer}', function($playlist_idx,$company_idx) {
    ...
    $model_result_list  = ModelResultM::new()->setPlaylistIdx($playlist_idx)->setTrainCompanyIdx($company_idx)->getList( 'score', 'desc', 60, 0 );
