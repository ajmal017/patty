<?php foreach($top_list as $top) { ?>
    <li>
        <a href="/company/view/<?php echo $top->getCompanyidx(); ?>" class="company-color" data-company="<?php echo $top->getCompanyIdx(); ?>">
        ...
        <div class="svm-match">
            <?php foreach($top->top_list as $result) { ?>
                <div class="match-item company-color-<?php echo $result->company->getIdx(); ?>">
